...
namespace StaticData.Tables
{
   ...
   public sealed class ClientTest4Table : TableBase<ClientTest4Record>
   {
       public ClientTest4Record GetByIndex(int index)
       {
       ...
       public bool TryGetByIndex(int index, out ClientTest4Record? record)
       {
           return _recordsByIndex.TryGetValue(index, out record);
       }

       public ClientTest4Record GetByKey(string key)
       {
       ...
       public bool TryGetByKey(string key, [NotNullWhen(true)] out ClientTest4Record? record)
       {
           ArgumentNullException.ThrowIfNull(key);
