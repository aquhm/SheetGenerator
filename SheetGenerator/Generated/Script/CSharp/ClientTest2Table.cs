...
namespace StaticData.Tables
{
   ...
   public sealed class ClientTest2Table : TableBase<ClientTest2Record>
   {
       public ClientTest2Record GetByIndex(int index)
       {
       ...
       public bool TryGetByIndex(int index, out ClientTest2Record? record)
       {
           return _recordsByIndex.TryGetValue(index, out record);
       }

       public ClientTest2Record GetByKey(string key)
       {
       ...
       public bool TryGetByKey(string key, [NotNullWhen(true)] out ClientTest2Record? record)
       {
           ArgumentNullException.ThrowIfNull(key);
       ...
       public object[][] BuildObjectValueMap()
       {
          ...
          for (int i = 0; i < _records.Count; i++)
          {
              ...
              result[i] = new object[] { record.Index, record.Key, record.Description, record.English, record.Korean };
          }
          return result;
       }
   }
